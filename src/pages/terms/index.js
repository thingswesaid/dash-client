...
export default () => (
  <div className="terms">
    <h3>DASH IN BETWEEN</h3>
    <h5>OVERVIEW</h5>
    <p>
      This website is operated by Dash in Between. Throughout the site, the terms
      <strong> “we”, “us” and “our”</strong>
      refer to
      <strong> Dash in Between</strong>
      . Dash in Between offers this website, including all
      information, tools and services available from this site to you, the user, conditioned
      upon your acceptance of all terms, conditions, policies and notices stated here. By visiting
      our site and/or purchasing something from us, you engage in our “Service” and agree to
      ...
      Terms of Service by posting updates and/or changes to our website. It is your responsibility
      to check this page periodically for changes. Your continued use of or access to the website
      following the posting of any changes constitutes acceptance of those changes.

      Our payments are entirely handled by PayPal which, currently, allows our users to pay via
      PayPal, PayPal credit, Venmo, Visa, Mastercard, Amex and Discover. No credit card information
    ...
    <p>
        ...
        your minor dependents to use this site. You may not use our products for any illegal
    ...
    <p>
      ...
      site at any time, but we have no obligation to update any information on our site. You
    ...
    <p>
      ...
      that are not affiliated with us. We are not responsible for examining or evaluating the
      content or accuracy and we do not warrant and will not have any liability or responsibility
      for any third-party materials or websites, or for any other materials, products, or
      services of third-parties. We are not liable for any harm or damages related to the
      purchase or use of goods, services, resources, content, or any other transactions made
      in connection with any third-party websites. Please review carefully the third-party's
      policies and practices and make sure you understand them before you engage in any
      transaction. Complaints, claims, concerns, or questions regarding third-party products
    ...
    <p>
      ...
      your order). We undertake no obligation to update, amend or clarify information in the
    ...
    <p>
      ...
      of the Service or of any related website, other websites, or the Internet; (h) to collect
      or track the personal information of others; (i) to spam, phish, pharm, pretext, spider,
    ...
    <p>
      ...
      time to time we may remove the service for indefinite periods of time or cancel the service
      at any time, without notice to you. You expressly agree that your use of, or inability to
      use, the service is at your sole risk. The service and all products and services delivered
      to you through the service are (except as expressly stated by us) provided 'as is' and 'as
      ...
      In no case shall Dash in Between, our directors, officers, employees, affiliates, agents, contractors,
    ...
    <p>
      You agree to indemnify, defend and hold harmless Dash in Between and our parent,
    ...
    <p>
      ...
      may terminate this agreement at any time without notice and you will remain liable for
      all amounts due up to and including the date of termination; and/or accordingly may deny
    ...
    <p>
      ...
      constitutes the entire agreement and understanding between you and us and govern your use
      of the Service, superseding any prior or contemporaneous agreements, communications and
      proposals, whether oral or written, between you and us (including, but not limited to,
      any prior versions of the Terms of Service). Any ambiguities in the interpretation of
    ...
    <p>
      ...
      be governed by and construed in accordance with the laws of Dash in Between.
    </p>
    ...
    <h5>SECTION 20 - RESPONSABILITIES</h5>
    <p>
      All tarot readings are for entertainment purposes only, and no guarantee can be given
      as to the accuracy of a reading. Users are responsible for their own life choices and
      decisions.
    </p>
    <h5>SECTION 21 - VIDEOS RETURNS AND REFUNDS</h5>
    <p>
      Thank you for your purchase and we hope you are enjoying every moment of our content.
      Given the nature of the items (extended videos), returns nor refunds requests are not
      accepted at the moment. We would love to have your feedback about any potential issue,
      we&#39;re always ready and happy to help and give you the best possible experience on
      our website. In case you ran into difficulties accessing the extended videos after
      making the payment, make sure to contact us at
      <strong> info@dashinbetween.com</strong>
    </p>
    <h5>SECTION 22 - CONTACT INFORMATION</h5>
    <p>
